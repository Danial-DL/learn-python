                        ...
                        with open("dataset_work_8.csv","r") as File :
                            ...
                            with open("dataset_work_8.csv","w") as File :
                                ...
                                if change == "name" :
                                    ...
                                    newCastsList = []
                                    New_num = int(input("Enter the number of actors : "))
                                    for i in range(New_num) :
                                        New_casts = input("Enter the desired new casts :")
                                        newCastsList.append(New_casts)
                                    str_li = ",".join(newCastsList)
                                    self.list2[5] = str_li.replace("," , "_")
                                elif change == "type" :
                                    while True:
                                        New_type = input("Enter the desired new type :")
                                        if New_type == "Serial" or New_type == "Film" or New_type == "Clip" or  New_type == "Documentary" :
...
#                 Store.add(NAME,DIRECTOR,IMDB,URL,DURATION,st2,TYPE)
#             elif choos == "search":
#                 Store.search()
#             elif choos == "show_all":
#                 Store.show_all()
